...
//! `UNSPECIFIED` on the wire. At 39 members (`Limitation`) that is not a
//! hypothetical.
//!
...
mod tests {
    ...
    /// The whole 39-member vocabulary, round-tripped by number. A member added
    ...
    /// the 1..=39 band a consumer iterates as "the vocabulary".
    #[test]
